...
@else
    <svg {{ $attributes->merge(['class' => 'h-auto w-56 max-w-full']) }} viewBox="0 0 560 144" fill="none" role="img" aria-label="trebbia. Centro Inteligente de Reservas y Agendamiento">
        ...
        <text x="138" y="69" fill="#0F172A" font-family="'Instrument Sans', 'Inter', 'Segoe UI', Arial, sans-serif" font-size="48" font-weight="750" letter-spacing="0">trebbia</text>
        <circle cx="316" cy="59" r="5.5" fill="url(#{{ $logoId }}-dot)" />
        <text x="140" y="101" fill="#64748B" font-family="'Instrument Sans', 'Inter', 'Segoe UI', Arial, sans-serif" font-size="13" font-weight="700" letter-spacing="3.4">CENTRO INTELIGENTE DE RESERVAS Y AGENDAMIENTO</text>
    </svg>
@endif
