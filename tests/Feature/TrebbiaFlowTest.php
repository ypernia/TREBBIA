...
class TrebbiaFlowTest extends TestCase
{
    ...
    public function test_settings_page_shows_users_and_business_summary(): void
    {
        ...
        $this->actingAs($user)
            ...
            ->assertOk()
            ->assertSee('data-settings-tab="profile"', false)
            ->assertSee('data-settings-tab="agenda"', false)
            ->assertSee('data-settings-tab="whatsapp"', false)
            ->assertSee('data-settings-panel="team"', false)
            ->assertSee('Perfil del negocio')
            ->assertSee('Preferencias de agenda')
            ->assertSee('Canal comercial WhatsApp')
            ->assertSee('Reservas por enlace y QR')
